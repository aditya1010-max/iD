...
// import { modeAddPoint, modeBrowse } from '../../modes';
...
//                 icon: 'iD-icon-point',
//                 onSelect: () => context.enter(context.modes.addPoint)
//             },
//             {
//                 id: 'add-line',
//                 title: t('modes.add_line.title'),
//                 icon: 'iD-icon-line',
//                 onSelect: () => context.enter(context.modes.addLine)
//             },
//             {
//                 id: 'add-area',
//                 title: t('modes.add_area.title'),
//                 icon: 'iD-icon-area',
//                 onSelect: () => context.enter(context.modes.addArea)
//             }
//         );
...
//             {
//                 id: 'undo',
//                 title: 'Undo', // Hardcoded to fix missing translation error
//                 icon: 'iD-icon-undo',
//                 onSelect: () => context.undo()
//             },
//             {
//                 id: 'redo',
//                 title: 'Redo', // Hardcoded to fix missing translation error
//                 icon: 'iD-icon-redo',
